...
with tab2:
    ...
    # Muestra los datos tal como están en tu DataFrame original
    st.dataframe(df[["Producto", "Stock", "Autonomia", "Acción Sugerida"]], use_container_width=True, hide_index=True)
...
with tab3:
    ...
    equipo = [
        ...
        ("Dalia R.", "Product Manager", "https://i.imgur.com/4O2B8L8.jpeg"), # URL corregida

...
<style>
    ...
    /* AGREGADO: Clase para Lectura Fácil (Inclusión Cognitiva) */
    .lectura-facil {
...
with st.sidebar:
    ...
    # AGREGADO: Herramientas de Inclusión Visual y Cognitiva
    ...
    # AGREGADO: Inclusión para zonas de baja conectividad
...
# --- CUERPO PRINCIPAL ---
# Aplicar clase de lectura fácil si está activa
...
# AGREGADO: Control por voz (Accesibilidad Motriz)
c_voz1, c_voz2 = st.columns([0.85, 0.15])
with c_voz2:
    if st.button("🎤 Voz"):
        st.toast("Escuchando... Di: 'Optimiza mis ventas'")
...
with tab_ins:
    # AGREGADO: Mención a estándares WCAG para el pitch
    ...
    # AGREGADO: Nota de Inclusión AMVO
